...
<head>
    ...
    <title>Registrar Tipo de Asignación</title>
    <!-- Fonts -->
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-5">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Registrar nuevo tipo de asignación</h3>
            ...
            <div class="mt-5 md:col-span-2 md:mt-0 md:mr-5">
                ...
                <form action="{{ route('tipoAsignacion.store') }}" method="POST">
                    <div class="overflow-hidden shadow sm:rounded-md">
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input type="text" name="type_asignation" value="{{ old('type_asignation') }}" id="type_asignation" class="inputForms"
                        ...
                        <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                            <button type="submit" class="btnGuardar">Registar Tipo de Asignación</button>
                        </div>
                    </div>
                </form>
            </div>

...
<div class="fondo">
    ...
    <div class="flex sm:rounded-lg md:mt-5 md:mx-10 md:my-0">
        ...
        <div class="w-1/4 flex flex-col items-end">
            <a href="{{ route('schoolPeriod.create') }}" class="text-white bg-azul-royal hover:bg-azul-royal-hover focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Añadir Nuevo</a>
        </div>
    </div>

    <form action="{{route('schoolPeriod.index')}}" method="GET" value="{{$search}}">
                ...
                <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownBgHoverButton">
                    ...
                    <li>
                        <div class="flex items-center">
                            <input id="period_number" type="radio" value="period_number" name="tipo" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                            <label for="period_number" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">N° de Periodo</label>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <label for="code" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Clave de Periodo</label>
                        </div>
                    </li>

                    <li>
                        <div class="flex items-center">
                            <input id="description" type="radio" value="description" name="tipo" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                            <label for="description" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Descripción</label>
                        </div>
                    </li>
                ...
                @foreach($schoolPeriods as $schoolPeriod)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        @if($schoolPeriod->current)
                            ...
                            <td class="py-4 px-6">
                                <form id="formPeriodoActual" action="{{ route('schoolPeriod.updateStatus',$schoolPeriod->code) }}" method="POST">
                                    @csrf
                        ...
                        <td class="py-4 px-6 text-right">
                            <a href="{{route('schoolPeriod.edit',$schoolPeriod->code)}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Editar</a>
                        </td>

                        <td class="py-4 px-6 text-right">
                            <button type="button"
                                    class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
                                    data-modal-toggle="delete-modal{{$schoolPeriod->code}}">Eliminar</button>
                        </td>

                    </tr>
                    @include('schoolPeriod.modalConfirmacionEliminar')
                @endforeach
            @endif
            </tbody>
        </table>

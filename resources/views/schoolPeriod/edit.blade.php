    ...
    <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:col-span-2 md:mt-0 md:mr-5">
                ...
                <form action="{{ route('schoolPeriod.update',$schoolPeriod->code) }}" method="POST">
                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <select  id="period_number" name="period_number" class="estiloSelect">
                                        <option value="{{$schoolPeriod->period_number}}">{{$schoolPeriod->period_number}}</option>

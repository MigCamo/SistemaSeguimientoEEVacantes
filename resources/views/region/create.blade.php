        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-5">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Registrar nueva Zona</h3>
                ...
                <form action="{{ route('region.store') }}" method="POST">
                    <div class="overflow-hidden shadow sm:rounded-md">
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    <label for="code" class="labelForms">Codigo de la Zona</label>
                                    <input type="text" name="code" id="code" class="inputForms"
                                           placeholder="Ej. 12345" required>
                                    <label for="name" class="labelForms">Nombre de la Zona</label>
                        ...
                        <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                            <button type="submit" class="btnGuardar">Registar Zona</button>
                        </div>
                    </div>
                </form>
            </div>

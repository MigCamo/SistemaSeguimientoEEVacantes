    ...
    <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:col-span-2 md:mt-0 md:mr-5">
                ...
                <form action="{{ route('educationalPrograms.update',$program->program_code) }}" method="POST" enctype="multipart/form-data">
                    <div class="overflow-hidden shadow sm:rounded-md">
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                @csrf

                                @include('educationalPrograms.selectDepartamentEdit')
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input type="text" name="program_code" id="program_code" class="inputForms"
                                           value="{{$program->program_code}}" required>
                                </div>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input type="number" name="usedhours" id="usedhours" class="inputForms"
                                           value="{{$program->usedhours}}" >
                                </div>

                                <div class="col-span-6">
                                    <label for="availablehours" class="labelForms">Horas Disponibles</label>
                                    <input type="number" name="availablehours" id="availablehours" class="inputForms"
                                           value="{{$program->availablehours}}" >
                                </div>
